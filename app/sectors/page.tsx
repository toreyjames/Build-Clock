  ...
  },
  {
    ...
    valueChain: [
      ...
      },
      {
        ...
        globalLeader: 'South Korea, Japan, France',
        gap: 'Critical',
        laborIntensity: 'High (precision manufacturing)',
      ...
      },
      {
        ...
        description: 'Build containment, install systems, commission',
        usCapacity: 'Limited (supply chain atrophied)',
    ...
    laborGap: {
      china: '$10-15/hour (South Korea)',
      us: '$30/hour',
      multiplier: '2-3x cost disadvantage',
    },
    aiSolutions: [
      'Construction automation (welding, inspection)',
      'Predictive maintenance (reduce downtime)',
